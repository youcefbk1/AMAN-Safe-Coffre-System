...
class Page9FR:
    ...
    def setup_gui(self):
        ...
        lbl1.grid(row=0, column=0, padx=20, pady=30, sticky="w")
        ...
        lbl2.grid(row=1, column=0, padx=20, pady=30, sticky="w")
        ...
        self.lbl_error.grid(row=2, column=1, padx=20, pady=10)

        frm_info.place(x=680, y=200)
