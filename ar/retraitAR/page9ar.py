...
class Page9AR:
    ...
    def setup_gui(self):
        ...
        self.entry_username.grid(row=0, column=0, padx=10, pady=15)
        ...
        self.entry_password.grid(row=1, column=0, padx=10, pady=15)
        ...
        self.lbl_error.grid(row=2, column=0, padx=10, pady=5)
