...
class Page8AR:
    ...
    def setup_gui(self):
        ...
        label_ticket.grid(row=0, column=1, sticky="e", padx=40)
        ...
        label_nom.grid(row=1, column=1, sticky="e", padx=40)
        ...
        label_mdp.grid(row=2, column=1, sticky="e", padx=40)
        ...
        label_coffre.grid(row=3, column=1, sticky="e", padx=40)
        ...
        label_montant.grid(row=4, column=1, sticky="e", padx=40)
        ...
        label_date.grid(row=0, column=0, padx=60)
        ...
        label2.grid(row=2, column=0, padx=60)
        ...
        label3.grid(row=3, column=0, padx=60)
        ...
        label4.grid(row=4, column=0, padx=60)

        frm_info.place(x=410, y=30)
