...
class Page5AR:
    ...
    def setup_gui(self):
        ...
        lbl_msg = Label(
            self.frm2,
            text="الرجاء تحديد الحجم الذي يناسبك",
            font=(("Arial", 46, "bold")),
            bg="#F2F7F9",
            fg="#095CD3",
        )
        ...
        self.lbl_diag.place(x=160, y=120)
        ...
        btn1 = CTkButton(
            ...
            border_width=0,
            corner_radius=4,
            command=lambda: self.switch_to_page6ar("A"),
        )
        ...
        btn2 = CTkButton(
            ...
            border_width=0,
            corner_radius=4,
            command=lambda: self.switch_to_page6ar("B"),
        )
        ...
        btn3 = CTkButton(
            ...
            border_width=0,
            corner_radius=4,
            command=lambda: self.switch_to_page6ar("C"),
        )
    ...
    def switch_to_page6ar(self, volume):
        ...
        Page6AR(self.master, self, self.cursor, self.conn)
